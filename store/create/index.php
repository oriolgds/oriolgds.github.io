...
<html lang="es">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary container" style="max-width: 500px;">
    ...
    <main class="form-signin w-100 m-auto">
        <form method="get" autocomplete="off" autocapitalize="off">
            ...
            <div class="form-floating my-1">
                <input type="text" class="form-control" id="inputUsername" placeholder="oriolgds" maxlength="30" required name="username">
